...
cd ~/advanced-kubernetes-workshop/services/frontend/; kubectx gke-central; kubectl config set-context $(kubectl config current-context) --namespace=dev; skaffold dev
